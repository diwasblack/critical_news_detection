...
Any article whose content satisfies all conditions shown in \tableref{tbl:significant_preconditions} could be labelled as significant and all other articles which does not meet those should be labelled as a non-significant.
